  ...
  render() {
    ...
    const renderCell = (dataArray, keyArray) => keyArray.map((itemCell, index) => {
      if (itemCell.id === 'market') {
        return (
          <TableCell padding="dense" numeric={itemCell.numeric} key={index.toString()}>
      ...
      if (itemCell.id === 'stats') {
        return (
          <TableCell padding="dense" numeric={itemCell.numeric} key={index.toString()} className={classes.chartTable}>
      ...
      return (
        <TableCell padding="dense" numeric={itemCell.numeric} key={index.toString()}>{dataArray[itemCell.id]}</TableCell>
      );
    });
    return (
